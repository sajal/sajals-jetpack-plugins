...
exports.dialog = function(input){
  ...
  this.show = function(){
    ...
    dialog = dialog.replace("{{ACCEPT}}", this.acceptbuttontext)
    dialog = dialog.replace("{{CANCEL}}", this.cancelbuttontext)
